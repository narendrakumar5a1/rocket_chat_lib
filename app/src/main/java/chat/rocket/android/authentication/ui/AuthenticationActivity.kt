...
class AuthenticationActivity : AppCompatActivity(), HasSupportFragmentInjector {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Log.i("App Flow" ,"onCreate - AuthenticationActivity");
    ...
    private fun processIncomingIntent(intent: Intent) {
        Log.i("App Flow" ,"onCreate - processIncomingIntent");
        if (intent.isSupportedLink(this)) {
            Log.i("App Flow" ,"onCreate - intent.isSupportedLink(this)");
            intent.data?.let { uri ->
    ...
    private fun loadCredentials() {
        Log.i("App Flow" ,"onCreate - loadCredentials");
        val newServer = intent.getBooleanExtra(INTENT_ADD_NEW_SERVER, false)
        Log.i("App Flow" ,"onCreate - loadCredentials - "+newServer);
        presenter.loadCredentials(newServer) { isAuthenticated ->
            Log.i("App Flow" ,"onCreate - loadCredentials - when "+isAuthenticated);
            when {
